...
def move_options(type: str, pos_id: int, arrey_map):
    options_list = []
...
def attack_options(type: str, pos_id: int, arrey_map):
    options_list = []
    ...
    if type.__contains__('w_pawn'):
        ...
        for step in (7, 9):
            ...
            if 0 < test < 65:
                if arrey_map[test][2]:
                    options_list.append(test)
        # print('debug attack options = ', options_list)
    ...
    # return options_list
        ...
        test = pos_id + 9
        if 0 < test < 65:
            if arrey_map[test][2] and not (str(arrey_map[test][0]).__contains__('A')):
                options_list.append(test)
        ...
        test = pos_id + 7
        if 0 < test < 65:
            if arrey_map[test][2] and not str(arrey_map[test][0]).__contains__('H'):
                options_list.append(test)
        ...
        test = pos_id - 10
        if 0 < test < 65:
            if arrey_map[test][2] and not any(val in arrey_map[test][0] for val in restrict_right):
                options_list.append(test)

        # knight : check #4
        test = pos_id - 6
        if 0 < test < 65:
            if arrey_map[test][2] and not any(val in arrey_map[test][0] for val in restrict_left):
                options_list.append(test)
